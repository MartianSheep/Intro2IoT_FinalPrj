...
int PIN_LORA_BUSY = 22;  // LORA SPI BUSY, actually DIO4
...
int RADIO_TXEN = 26;   // LORA ANTENNA TX ENABLE, actually DIO0
int RADIO_RXEN = 27;   // LORA ANTENNA RX ENABLE, actually DIO5
...
void setup()
{
  ...
  hwConfig.CHIP_TYPE = SX1262_CHIP;     // 1268
