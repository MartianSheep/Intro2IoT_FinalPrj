...
export default class MapTypeScatterPolylineSeries extends React.Component {
  ...
  public onMapRef(geoMap: IgrGeographicMap) {
    ...
    sds.shapefileSource =
      "https://static.infragistics.com/xplatform/shapes/AmericanRoads.shp";
    sds.databaseSource =
      "https://static.infragistics.com/xplatform/shapes/AmericanRoads.dbf";
    sds.dataBind();
  }
    ...
    return (
      <div className="tooltipBox">
        <div style={titleStyle}>
          {dataItem.country} {dataItem.type}
        </div>
